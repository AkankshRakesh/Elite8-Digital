    ...
    <div className='my-64'>
      ...
      <div ref = {ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full sm:w-full xs:w-full'>
        ...
        <ul className='w-full flex flex-col justify-between ml-2 xs:ml-2'>
            ...
            <Details 
            type = "Team lead and Web Development Intern"
            time = "Winter 2024"
            place = "VENQ Technologies"
            info = "Designed and optimized the web platform for high performance, mentored a team, and collaborated with cross-functional teams on business-critical projects." />
        </ul>
      </div>
    </div>
  )
