...
import pic7 from "../../public/images/projects/audioscribe.png";
import pic8 from "../../public/images/projects/syncflow.png";
import pic9 from "../../public/images/projects/gadgetglimpse.png";
import pic10 from "../../public/images/projects/medilink.png";
import pic11 from "../../public/images/projects/ACO.png";
import pic12 from "../../public/images/projects/righthomes.png"
        ...
        <Layout className="pt-16">
          ...
          <div
            className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0
                    md:gap-x-8 sm:gap-y-24 xs:gap-x-0 xs:gap-y-20"
          >
            <div className="col-span-12">
              <FeaturedProject
                ...
                github="https://github.com/AkankshRakesh/KYR"
            ...
            <div className="col-span-6 sm:col-span-12 xs:col-span-12">
              <Project
                ...
                github="https://github.com/AkankshRakesh/GadgetGlimpse"
                type="Next.js app with a ML model to fetch product data"
              />
            </div>
            <div className="col-span-6 sm:col-span-12 xs:col-span-12">
              <Project
                title="Medilink"
                img={pic10}
                link="https://moodl-wheat.vercel.app/"
                github="https://github.com/AkankshRakesh/Medilink"
                type="Next.js + PHP app for dynamic slot booking"
              />
            </div>
            <div className="col-span-6 sm:col-span-12 xs:col-span-12">
              <Project
                title="Syncflow"
                img={pic8}
                link="https://syncflow-three.vercel.app/"
                github="https://github.com/AkankshRakesh/ProjectManagement"
                type="A workflow management app built on PostgreSQL"
              />
            </div>
            <div className="col-span-6 sm:col-span-12 xs:col-span-12">
              <Project
            ...
            <div className="col-span-6 sm:col-span-12 xs:col-span-12">
              <Project
                title="AudioBridge"
                img={pic7}
                link="https://audiobridge.vercel.app/"
                github="https://github.com/AkankshRakesh/Translator"
                type="ML model on MERN to transcribe audio to text"
              />
            </div>
            <div className="col-span-6 sm:col-span-12 xs:col-span-12">
              <Project
                title="ACO Simulator"
                img={pic11}
                link="https://aco-rho.vercel.app/"
                github="https://github.com/AkankshRakesh/Load-balance-simulator"
                type="Simulation of my patented algorithm"
              />
            </div>
            <div className="col-span-6 sm:col-span-12 xs:col-span-12">
              <Project
            ...
            <div className="col-span-6 sm:col-span-12 xs:col-span-12">
              <Project
                title="RightHomes"
                img={pic12}
                link="https://righthomes.vercel.app/"
                github="https://github.com/AkankshRakesh/RightHomes"
                type="AI assistant on Next.js and Angular"
              />
            </div>
            <div className="col-span-6 sm:col-span-12 xs:col-span-12">
              <article
