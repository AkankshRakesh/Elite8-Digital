          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8 xs:gap-8">
            ...
            lg:col-span-4 md:col-span-8 sm:col-span-8 xs:col-span-8 md:order-2 sm:order-2 xs:order-2">
              ...
              <p className="font-medium">
                - Hi, I&apos;m Akanksh Rakesh, an experienced web developer and UI/UX designer with a
              ...
              <p className="font-medium">
                - Whether I&apos;m working on a website, mobile app, or any other digital
                product, I bring strong commitment to excellence and
                user-centric thinking to every project I work on. With growing expertise in
